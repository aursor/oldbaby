import { hasInjectionContext, getCurrentInstance, inject, version, h, useSSRContext, ref, watchEffect, watch, defineComponent, computed, resolveComponent, nextTick, useSlots, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createApp, reactive, unref, createTextVNode, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, Suspense, Transition } from 'vue';
...
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderAttrs, ssrRenderAttr, ssrRenderStyle, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-5d593452.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-daa9083c.mjs').then((m) => m.default || m)
  },
  {
    name: "product",
    path: "/product",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/product-a581bc17.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_zDkwfLJt3u = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_pZYD5nddNz = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const colors_HYTrROa0t9 = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  plugin,
  revive_payload_server_zDkwfLJt3u,
...
_sfc_main$7.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxthq+ui@2.6.0_vue@3.3.4_webpack@5.88.2/node_modules/@nuxthq/ui/dist/runtime/components/forms/Textarea.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxthq+ui@2.6.0_vue@3.3.4_webpack@5.88.2/node_modules/@nuxthq/ui/dist/runtime/components/elements/Icon.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxthq+ui@2.6.0_vue@3.3.4_webpack@5.88.2/node_modules/@nuxthq/ui/dist/runtime/components/forms/Input.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxthq+ui@2.6.0_vue@3.3.4_webpack@5.88.2/node_modules/@nuxthq/ui/dist/runtime/components/elements/Button.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$1]]);
const _imports_0 = "" + __publicAssetsURL("zx.png");
const _imports_1 = "" + __publicAssetsURL("close.svg");
const _sfc_main$3 = {
  __name: "ReportButton",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["ReportButton", [open.value ? "ReportButton-form" : "ReportButton-button"]]
      }, _attrs))} data-v-d1dd6553>`);
      if (!open.value) {
        _push(`<img${ssrRenderAttr("src", _imports_0)} width="30" data-v-d1dd6553>`);
      } else {
        _push(`<div style="${ssrRenderStyle({ "position": "'relative'" })}" data-v-d1dd6553><div style="${ssrRenderStyle({
          padding: "24px",
          "background-color": "rgb(10, 151, 121)",
          color: "#fff",
          display: "flex",
          justifyContent: "space-between"
        })}" data-v-d1dd6553><span data-v-d1dd6553>请您留言</span><img width="24"${ssrRenderAttr("src", _imports_1)} alt="" data-v-d1dd6553></div><div style="${ssrRenderStyle({
          padding: "24px"
        })}" data-v-d1dd6553>`);
        _push(ssrRenderComponent(_component_UTextarea, {
          rows: "4",
          placeholder: "在此输入留言内容，我们将尽快与您联系"
        }, null, _parent));
        _push(`<br data-v-d1dd6553>`);
        _push(ssrRenderComponent(_component_UInput, { placeholder: "您的姓名" }, null, _parent));
        _push(`<br data-v-d1dd6553>`);
        _push(ssrRenderComponent(_component_UInput, { placeholder: "您的邮箱" }, null, _parent));
        _push(`<br data-v-d1dd6553>`);
        _push(ssrRenderComponent(_component_UInput, { placeholder: "您的联系方式" }, null, _parent));
        _push(`<p style="${ssrRenderStyle({ "color": "#999" })}" data-v-d1dd6553><small data-v-d1dd6553>您的信息我们将严格保密</small></p><div style="${ssrRenderStyle({ "text-align": "right", "width": "100%", "position": "absolute", "bottom": "20px", "padding": "0 36px", "box-sizing": "border-box" })}" data-v-d1dd6553>`);
        _push(ssrRenderComponent(_component_UButton, { style: { "background-color": "rgb(10, 151, 121)" } }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`提交`);
            } else {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ReportButton.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d1dd6553"]]);
const _sfc_main$2 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtPage = __nuxt_component_0$2;
  const _component_ReportButton = __nuxt_component_1;
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
  _push(ssrRenderComponent(_component_ReportButton, null, null, _parent));
  _push(`</div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-899438d7.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-7898ce8b.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.6.5_@types+node@18.17.0_sass@1.64.1/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.6.5_@types+node@18.17.0_sass@1.64.1/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$3 as a, __nuxt_component_2 as b, createError as c, useRoute as d, entry$1 as default, appLayoutTransition as e, _wrapIf as f, useNuxtApp as g, useHead as u };
